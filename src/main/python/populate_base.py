...
from src.main.python.movie.imdb import _get_french_info
...
for username in df_users['user']:
    ...
    alert = pd.read_csv('/home/houssam/Documents/retroproj/data/yndi.csv')
    data = pd.read_csv('/home/houssam/Documents/retroproj/data/base.csv')
